    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        @foreach ($promo as $item)
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <img src="{{ asset('storage/' . $item->foto) }}" alt="{{ $item->nama_promo }}" class="w-full h-70 object-cover">
                <div class="p-4">               
                    <h3 class="text-lg font-semibold text-[rgb(83,125,93)]">{{ $item->nama_promo }}</h3>                            
